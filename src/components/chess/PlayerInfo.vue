...
export default defineComponent({
  ...
  computed: {
    getBoardPosition() {
      return this.boardPosition === 'top' ? 'top-player' : 'bottom-player'
    }
  }
})
</script>
...
<template>
  <div class="player-info-container" :class="getBoardPosition">
    <div class="player-info-name">
      <div class="player-info-image-container">
        <img
      ...
      <h3 class="player-rating">({{ playerRating }})</h3>
    </div>
    <div class="player-info-timer">
